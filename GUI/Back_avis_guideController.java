...
import controllers.AvisEvenementController;
 ...
 * @author HP OMEN
 */
public class Back_avis_guideController implements Initializable {
    ...
    public int note = 0;
    ObservableList<avis_guide> avis_event = FXCollections.observableArrayList();
    @FXML
    private TableColumn<avis_guide, Integer> likecol;
    @FXML
    private TableColumn<avis_guide, Integer> dislikecol;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
        refreshbut.setOnAction((ActionEvent event) -> {
            try {
        ...
        try {
            List<avis_guide> listAvisEvenement = service.Affichertout_user_avis_guide();
            ...
            col_id_rec.setCellValueFactory(new PropertyValueFactory<>("guide_id"));
        ...
        javafx.util.Callback<TableColumn<avis_guide, String>, TableCell<avis_guide, String>> cellFactory
                = new Callback<TableColumn<avis_guide, String>, TableCell<avis_guide, String>>() {
            public TableCell call(final TableColumn<avis_guide, String> param) {
                final TableCell<avis_guide, String> cell = new TableCell<avis_guide, String>() {
                        ...
                        if (empty) {
                            ...
                            btn.setOnAction(event -> {
                                ...
                                if (action.get() == ButtonType.OK) {
                                    avis_guide u = getTableView().getItems().get(getIndex());
                                    try {
                                        service.Supprimer_avis_guide(u.getAvis_id());
