...
public class AvisGuideController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
                    ...
                    public void updateItem(String item, boolean empty) {
                        ...
                        if (empty) {
                            ...
                            btn.setOnAction(event -> {
                                ...
                                service.update_avis_guide_likes(u.getAvis_id(), u.getLikes() + 1);
        ...
        javafx.util.Callback<TableColumn<avis_guide, String>, TableCell<avis_guide, String>> cellFactory1
                = new Callback<TableColumn<avis_guide, String>, TableCell<avis_guide, String>>() {
            public TableCell call(final TableColumn<avis_guide, String> param) {
                final TableCell<avis_guide, String> cell = new TableCell<avis_guide, String>() {
                    ...
                    public void updateItem(String item, boolean empty) {
                        ...
                        if (empty) {
                            ...
                            btn.setOnAction(event -> {
                                ...
                                service.update_avis_guide_dislikes(u.getAvis_id(), u.getDislikes() + 1);
                                System.out.println("id supp =" + u.getAvis_id());
                                try {
                                    refreche();
                                } catch (SQLException ex) {
    ...
    public void refreche() throws SQLException {
        ...
        tab_Reclamation.setItems(service.Affichertout_user_avis_guide());
        tab_Reclamation.getItems().clear();
        tab_Reclamation.setItems(service.Affichertout_user_avis_guide());
